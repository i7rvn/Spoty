package com.infinity.spoty.updater_lib
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/i7rvn/Spoty/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
        } else {
            "https://github.com/i7rvn/Spoty/releases/download/$versionName/vivi.apk"
        }
