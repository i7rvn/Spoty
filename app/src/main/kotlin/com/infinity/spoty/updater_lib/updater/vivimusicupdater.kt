...
package com.infinity.spoty.updater_lib.updater
...
import com.infinity.spoty.updater_lib.updater.downloadmanager.UpdateDownloadWorker
import com.infinity.spoty.updater_lib.updater.downloadmanager.DownloadNotificationManager
...
import com.infinity.spoty.ui.component.ChangelogItem
import com.infinity.spoty.ui.component.leadingItemShape
import com.infinity.spoty.ui.component.middleItemShape
import com.infinity.spoty.ui.component.endItemShape
import com.infinity.spoty.ui.component.detachedItemShape
import com.infinity.spoty.ui.component.AnimatedActionButton
import com.infinity.spoty.ui.component.ExpressiveIconButton
import com.infinity.spoty.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/i7rvn/Spoty/releases/download/${currentStatus.version}/vivi.apk"
                                ...
                                Column(
                                    ...
                                    currentStatus.changelog.forEach { section ->
                                        ...
                                        section.items.forEachIndexed { index, item ->
                                            val shape = when {
                                                section.items.size == 1 -> com.infinity.spoty.ui.component.detachedItemShape()
                                                index == 0 -> com.infinity.spoty.ui.component.leadingItemShape()
                                                index == section.items.size - 1 -> com.infinity.spoty.ui.component.endItemShape()
                                                else -> com.infinity.spoty.ui.component.middleItemShape()
                                            }
                                            com.infinity.spoty.ui.component.ChangelogItem(
                                                text = item,
                                                shape = shape,
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/i7rvn/Spoty/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/i7rvn/Spoty/actions/workflows/nightly.yml/runs?status=success&per_page=100")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/i7rvn/Spoty/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/i7rvn/Spoty/releases/download/$tagWithPrefix/changelog.json")
