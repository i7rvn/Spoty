...
package com.infinity.spoty.widget
...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "com.infinity.spoty.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "com.infinity.spoty.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "com.infinity.spoty.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "com.infinity.spoty.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
