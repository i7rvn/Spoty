...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.infinity.spoty.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.infinity.spoty.widget.LIKE"
        const val ACTION_NEXT = "com.infinity.spoty.widget.NEXT"
        const val ACTION_PREVIOUS = "com.infinity.spoty.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.infinity.spoty.widget.UPDATE_WIDGET"
    }
}
