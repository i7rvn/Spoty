...
package com.infinity.spoty.listentogether
...
import com.infinity.spoty.constants.ListenTogetherIsHostKey
import com.infinity.spoty.constants.ListenTogetherRoomCodeKey
import com.infinity.spoty.constants.ListenTogetherServerUrlKey
import com.infinity.spoty.constants.ListenTogetherSessionTimestampKey
import com.infinity.spoty.constants.ListenTogetherSessionTokenKey
import com.infinity.spoty.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.infinity.spoty.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.infinity.spoty.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.infinity.spoty.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.infinity.spoty.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.infinity.spoty.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.infinity.spoty.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
